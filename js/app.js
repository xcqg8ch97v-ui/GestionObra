...
// Actualizado: 2026-04-13
  ...
  const TRANSLATIONS = {
    es: {
      ...
      section_participants: 'Trabajadores',
      ...
      no_name: 'Sin nombre',
      edit_participant: 'Editar trabajador',
      new_participant: 'Nuevo trabajador',
      ...
      phone: 'Teléfono',
      email: 'Email',
      participant_name_required: 'El nombre del trabajador es obligatorio',
      participant_updated: 'Trabajador actualizado',
      participant_added: 'Trabajador añadido',
      confirm_delete_participant: '¿Eliminar este trabajador?',
      participant_deleted: 'Trabajador eliminado',
      ...
      plan_anno_select: 'Seleccionar y mover',
      ...
      plan_anno_duplicate: 'Duplicar selección',
      plan_anno_delete: 'Eliminar selección',
      ...
      participants_title: 'Trabajadores',
        ...
        add_participant: 'Añadir trabajador',
      ...
      participants_search_placeholder: 'Buscar trabajador...',
      ...
      participants_import_pdf_analyzing: 'Analizando PDF de trabajadores…',
      participants_import_pdf_no_matches: 'No se detectaron trabajadores válidos en el PDF',
      participants_import_pdf_error: 'No se pudo procesar el PDF de trabajadores',
      participants_import_pdf_modal_title: 'Importar trabajadores desde PDF',
      participants_import_pdf_candidates: '{{count}} trabajador(es) detectado(s)',
      participants_import_pdf_confirm_button: 'Crear seleccionados',
      participants_import_pdf_none_selected: 'Selecciona al menos un trabajador',
      participants_import_pdf_final_confirm: 'Se crearán {{count}} trabajadores. ¿Deseas continuar?',
      ...
      participants_no_participants: 'No hay trabajadores registrados',
      participants_add_first: 'Añadir primer trabajador',
      workers_group_no_company: 'Sin empresa asignada',
      workers_group_internal: 'Equipo interno',
      workers_group_external: 'Equipo externo',
      workers_total_label: '{{count}} trabajador(es)',
      workers_documents_title: 'Documentos de trabajadores',
      workers_documents_empty: 'Aún no hay PDFs de trabajadores',
      workers_toggle_hide: 'Ocultar grupo',
      workers_toggle_show: 'Mostrar grupo',
      workers_notes_tooltip: 'Notas del trabajador',
      exit: 'Salir',
      edit: 'Editar',
      undo: 'Deshacer',
      pending: 'Pendiente',
    ...
    en: {
      ...
      no_name: 'No name',
      edit_participant: 'Edit worker',
      new_participant: 'New worker',
      full_name: 'Full name',
      type: 'Type',
      role: 'Role / Position',
      select: 'Select...',
      ...
      phone: 'Phone',
      email: 'Email',
      participant_name_required: 'Worker name is required',
      participant_updated: 'Worker updated',
      participant_added: 'Worker added',
      confirm_delete_participant: 'Delete this worker?',
      participant_deleted: 'Worker deleted',
      ...
      plan_anno_select: 'Select and move',
      ...
      plan_anno_duplicate: 'Duplicate selection',
      plan_anno_delete: 'Delete selection',
      plan_anno_undo: 'Undo',
      ...
      participants_title: 'Workers',
      participants_search_placeholder: 'Search worker...',
      ...
      participants_import_pdf_analyzing: 'Analyzing workers PDF…',
      participants_import_pdf_no_matches: 'No valid workers were detected in the PDF',
      participants_import_pdf_error: 'Could not process workers PDF',
      participants_import_pdf_modal_title: 'Import workers from PDF',
      participants_import_pdf_candidates: '{{count}} worker(s) detected',
      participants_import_pdf_confirm_button: 'Create selected',
      participants_import_pdf_none_selected: 'Select at least one worker',
      participants_import_pdf_final_confirm: '{{count}} workers will be created. Continue?',
      ...
      participants_no_participants: 'No workers registered',
      participants_add_first: 'Add first worker',
      exit: 'Exit',
      edit: 'Edit',
      undo: 'Undo',
      pending: 'Pending',
